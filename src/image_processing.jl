...
function files2cells(data_dir,tifs_names;illumination=nothing)
    ...
    for tif_name in tifs_names
        ...
        cells, I_sub, DIC_labels, overlays  = img2cells(img_new,illumination,illumination_smooth)
...
function img2cells(img,illumination,illumination_smooth;MTP_channel=1)
    ...
    I_MTP = illumination_correction_MTP(I_MTP_no_outl,illumination,illumination_smooth)
